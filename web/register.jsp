...
<div id="register" class="wrap">
	<div class="shadow">
		...
		<div class="box">
			...
			<form id="regForm" method="post" action="insertu.do" onsubmit="return checkForm(this);">
				<table>
					<tr>
					...
					<tr>
						...
						<td><input class="text" type="text" name="sex" onfocus="FocusItem(this)" onblur="CheckItem(this);" /><span></span></td>
					</tr>
					<tr>
						<td class="field">出生日期：</td>
						<td><input class="text" type="text" name="brithday" onfocus="FocusItem(this)" onblur="CheckItem(this);" /><span></span></td>
					</tr>
					<tr>
