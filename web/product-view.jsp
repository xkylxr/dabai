...
<div id="main" class="wrap">
	...
	<div id="product" class="main">
		...
		<h1>${pr.epName}</h1>
		<div class="infos">
			<div class="thumb"><img src="${pr.epFileName}" /></div>
			<div class="buy">
				<p>商城价：<span class="price">￥${pr.epPrice}</span></p>
				<c:if test="${pr.epStock==0}">
				<p>库　存：无货</p>
				</c:if>
				<c:if test="${pr.epStock!=0}">
				<p>库　存：有货</p></c:if>
				<div class="button"><input type="button" name="button" value="" onclick="goBuy(${pr.epTd})"  /><a href="#">放入购物车</a></div>
			</div>
			<div class="clear"></div>
		</div>
		<div class="introduce">
